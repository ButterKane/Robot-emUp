...
Shader "MasterChara_Toon"
{
	Properties
	{
		...
		_BehindColor("Behind Color", Color) = (0,0,0,0)
...
#define _ASEOutlineWidth_arr MasterChara_Toon
		...
		inline half4 LightingOutline(SurfaceOutput s, half3 lightDir, half atten) { return half4 (0,0,0, s.Alpha); }
		void outlineSurf(Input i, inout SurfaceOutput o) { o.Emission = _BehindColor; o.Alpha = 1; }
		ENDCG
...
#define _DirtColor_arr MasterChara_Toon
			UNITY_DEFINE_INSTANCED_PROP(float4, _BehindColor)
#define _BehindColor_arr MasterChara_Toon
